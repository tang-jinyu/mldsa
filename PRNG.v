...
module PRNG #( // 5462, 3067
    ...
    // KeccakCore
    wire[1343:0] i_data_KeccakCore  ;
    reg          i_valid_KeccakCore ;
    wire[1343:0] o_data_KeccakCore  ;
    reg [1343:0] keccak_chain_state ;
    ...
    always @(*)begin
        case(cur_state_child)
            ...
            ABSORB_WAIT  : nxt_state_child = o_idle_KeccakCore ? (more_1round?ABSORB_FINAL:ABSORB_LOAD) : ABSORB_WAIT ;
    ...
    // KeccakCore
    assign i_data_KeccakCore = r_wire^keccak_chain_state;
    // Output
